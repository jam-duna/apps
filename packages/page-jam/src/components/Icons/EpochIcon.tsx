...
export function EpochIcon({size, color}: IconProps) {
  return (
    <svg
      ...
      stroke={color}>
        <g>
          <path d="M26 26H2V3.88452H26V26Z" strokeMiterlimit="10"></path>
          <path d="M9.42337 6.34171V2" strokeMiterlimit="10"></path>
          <path d="M18.5764 6.34177V2.00006" strokeMiterlimit="10"></path>
