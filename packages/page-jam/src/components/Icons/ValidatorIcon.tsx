    ...
    <svg
      ...
      stroke={color}>
        <g>
          ...
          <path d="M5.99593 10.0054C5.99593 14.4267 9.58006 18.0108 14.0013 18.0108C18.4226 18.0108 22.0067 14.4267 22.0067 10.0054C22.0067 5.58414 18.4226 2 14.0013 2C9.58006 2 5.99593 5.58414 5.99593 10.0054Z" stroke-miterlimit="10"></path>
        </g>
    </svg>
  )
}
