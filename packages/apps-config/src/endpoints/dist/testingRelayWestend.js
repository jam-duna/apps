...
exports.testRelayWestend = exports.testParasWestendCommon = exports.testParasWestend = void 0;
...
exports.testParasWestend = [
    ...
    },
    {
        ...
        ui: {
            color: '#53cbc9',
            logo: index_js_2.nodesMoonshadowPNG
        }
    },
    {
        info: 'westendPenpal',
    ...
    },
    {
        ...
        text: 'Standard',
        ui: {
            logo: index_js_1.chainsStandardPNG
        }
    },
    {
        info: 'karura',
...
exports.testParasWestendCommon = [
    {
...
exports.testRelayWestend = {
    dnslink: 'westend',
    genesisHash: constants_js_1.WESTEND_GENESIS,
    info: 'westend',
    isPeopleForIdentity: true,
    isRelay: true,
    linked: __spreadArrays(exports.testParasWestendCommon, exports.testParasWestend),
    providers: {
    ...
    teleport: util_js_1.getTeleports(exports.testParasWestendCommon),
    text: 'Westend',
    ui: {
        color: '#da68a7',
        identityIcon: 'polkadot',
        logo: index_js_2.nodesWestendColourSVG
    }
};
